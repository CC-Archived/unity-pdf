...
package com.codecatalyst.pdf.graphics
{
 ...
 * 
 * NOTE: This implementation has been modified to include support for toggling bitmap smoothing and specifying a background color.
 */
public dynamic class ImageSnapshot
{
    ...
    public static function captureBitmapData(
								...
								backgroundColor:uint = 0x000000 ):BitmapData
    {
        var data:BitmapData;
        var width:int;
        var height:int;
        ...
        try
        {
            ...
            data = new BitmapData(scaledWidth, scaledHeight, true, backgroundColor);
    ...
    public static function captureImage(
								...
								smoothing:Boolean = false,
								backgroundColor:uint = 0x00000000):ImageSnapshot
    {
        ...
        try
        {
            ...
            {
                var data:BitmapData = captureBitmapData(source, matrix, null, null, null, smoothing, backgroundColor);
            ...
            else
            {
                ...
                bytes = captureAll(source, bounds, matrix, null, null, null, false, backgroundColor);
    ...
    private static function captureAll(source:IBitmapDrawable, bounds:Rectangle,
                                       ...
                                       clipRect:Rectangle = null,
                                       smoothing:Boolean = false,
									   backgroundColor:uint = 0x000000):ByteArray
    {
        ...
        // the fill should be transparent: 0xARGB -> 0x00000000
        // only explicitly drawn pixels will show up
        var data:BitmapData = new BitmapData(topLeft.width, topLeft.height, true, backgroundColor);
        ...
        if (topRight != null)
        {
            ...
            topRight.x = 0;
            topRight.y = 0;
            var topRightPixels:ByteArray = captureAll(source, topRight, 
            	                                      currentMatrix, 
               	                                      null, null, null, 
            	                                      smoothing, 
            	                                      backgroundColor);
        ...
        if (bottomLeft != null)
        {
            ...
            if (bottomRight != null)
            {
                ...
                bottomRight.x = 0;
                bottomRight.y = 0;
                var bottomRightPixels:ByteArray = captureAll(source, bottomRight,
                                                             currentMatrix,
                                                             null, null, null, 
                                                             smoothing, 
                                                             backgroundColor);
